...
public class UpdateNoti extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_noti);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.update) {
            ...
            try {
                ...
                db.open();
                if (db.updateContact(id, c, d, mnth, yr, hr, min, de)) {
                    addNotification();
                    Toast.makeText(UpdateNoti.this, "Update Successfull", Toast.LENGTH_LONG).show();

                } else
                    Toast.makeText(UpdateNoti.this, "Update Unsuccessfull", Toast.LENGTH_LONG).show();
                db.close();

                Intent i = new Intent(UpdateNoti.this, MainActivity.class);
                startActivity(i);
                finish();

            } catch (Exception e) {
                Toast.makeText(UpdateNoti.this, "Please enter all details", Toast.LENGTH_LONG).show();
            }
