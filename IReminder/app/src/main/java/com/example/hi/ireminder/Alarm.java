...
public class Alarm extends Fragment {
    ...
    private void getList() {
        db.open();
        Cursor c = db.getReminderName("alarm");
        if(c!=null) {
            if (c.moveToFirst()) {
                do {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v;
        SharedPreferences app_preferences = PreferenceManager.getDefaultSharedPreferences(this.getActivity());
        int isEmpty      = app_preferences.getInt("isemptyalarm", 0);
        ...
        if(isEmpty!=0)
        {
            ...
            recycle= (RecyclerView) v.findViewById(R.id.recycleview3);
